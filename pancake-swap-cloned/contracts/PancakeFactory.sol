...
interface IPancakePair {
    ...
    event Sync(uint112 reverse0, uint112 reverse1);

    function MINIMUM_LIQUIDITY() external pure returns (uint);
    function factory() external view returns (address);
    function token0() external view returns (address);
    function token1() external view returns (address);
    function getReverses() external view returns (uint112 reverse0, uint112 reverse1, uint32 blockTimestampLast);
    function price0CummulativeLast() external view returns (uint);
    function price1CummulativeLast() external view returns (uint);
